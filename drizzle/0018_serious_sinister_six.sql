CREATE TYPE "public"."purpose" AS ENUM('bot_link', 'user_link');--> statement-breakpoint
ALTER TABLE "linking_codes" DROP CONSTRAINT "linking_codes_userId_unique";--> statement-breakpoint
ALTER TABLE "linking_codes" ADD COLUMN "purpose" "purpose" DEFAULT 'bot_link' NOT NULL;--> statement-breakpoint
